...
import 'package:careo_new/model/exercise_set.dart';
...
final exerciseSets = [
  ExerciseSet(
    ...
    imageUrl: 'assets/icon/workout1.png',
  ...
  ExerciseSet(
    ...
    imageUrl: 'assets/icon/crunch.png',
    exerciseType: ExerciseType.low,
  ...
  ExerciseSet(
    name: 'Upper Body',
    exercises: exercises1,
    imageUrl: 'assets/icon/pushup.png',
    exerciseType: ExerciseType.low,
  ...
  ExerciseSet(
    name: 'Cardio',
    exercises: exercises3,
    imageUrl: 'assets/icon/workout3.png',
    exerciseType: ExerciseType.low,
  ...
  ExerciseSet(
    ...
    imageUrl: 'assets/icon/workout2.png',
